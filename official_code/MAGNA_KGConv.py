...
#//ent_embed - embeddings for entities, rel_embed - relation embeddings 
...
#//graph_rel_norm() LayerNorm(num_features=in_rel_feats)  # relation feature normalization
...
#// fc_rel - nn.Linear(in_rel_feats, out_feats, bias=False)

        h = self.graph_ent_norm(ent_embed)3
